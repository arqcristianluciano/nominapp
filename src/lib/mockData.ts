...
const company = {
  id: companyId,
  name: 'Constructora Quisqueya SRL',
  rnc: '130-45678-9',
  created_at: now,
  updated_at: now,
}
...
export const SEED_DATA: Record<string, Record<string, unknown>[]> = {
  ...
  contractors: [
    ...
    },
    {
      id: contractor2,
      name: 'Lenin Marte',
      specialty: 'Plomería e instalaciones',
      ...
      payment_method: 'cash',
      is_active: true,
      notes: 'Botes y movimientos de tierra',
      created_at: now,
      updated_at: now,
    },
    {
    ...
    },
    {
      id: contractor4,
      name: 'Joan Pimentel',
      specialty: 'Ebanistería y carpintería',
  ...
  suppliers: [
    {
      id: supplier1,
      name: 'Ferretería Bellón',
      rnc: '101-23456-7',
      contact_phone: '809-555-1001',
      bank_account: null,
      bank_name: null,
    ...
    {
      id: supplier3,
      name: 'Ferretería Pappaterra',
      rnc: '101-45678-9',
      contact_phone: '809-555-1003',
      bank_account: null,
      bank_name: null,
    ...
    {
      id: supplier4,
      name: 'Hormigones Nacionales',
      rnc: '101-56789-0',
      contact_phone: '809-555-1004',
    ...
    {
      id: supplier5,
      name: 'Acero del Cibao',
      rnc: '101-67890-1',
      contact_phone: '809-555-1005',
      bank_account: null,
      bank_name: null,
      payment_terms: 'Crédito 30 días',
      is_active: true,
  ...
  bank_accounts: [
    {
      id: bank1,
      owner_name: 'Constructora Quisqueya SRL',
      bank_name: 'Banco Santa Cruz',
      account_number: '8001-2345-6789',
      account_type: 'Corriente',
      cedula_rnc: '130-45678-9',
      is_internal: true,
      project_id: null,
    },
    {
  ...
  // Detalle de items por factura. Los montos suman el total de cada factura
  // (material_invoices.amount) para mantener la consistencia con los reportes.
  material_invoice_items: [
    {
      id: 'mii0101',
      material_invoice_id: 'mi01',
      description: 'CEMENTO GRIS CIBAO X50',
      amount: 150000,
      sort_order: 0,
    },
    {
      id: 'mii0102',
      material_invoice_id: 'mi01',
      description: 'FUNDAS DE CEMENTO ADICIONALES',
      amount: 37500,
      sort_order: 1,
    },
    { id: 'mii0201', material_invoice_id: 'mi02', description: 'HORMIGON 210 KG/CM2', amount: 135000, sort_order: 0 },
    { id: 'mii0301', material_invoice_id: 'mi03', description: 'VARILLAS 3/8', amount: 50000, sort_order: 0 },
    { id: 'mii0302', material_invoice_id: 'mi03', description: 'VARILLAS 1/2', amount: 40000, sort_order: 1 },
    {
      id: 'mii2101',
      material_invoice_id: 't2mi01',
      description: 'HORMIGON 280 KG/CM2 — BOMBA',
      amount: 285000,
      sort_order: 0,
    },
    { id: 'mii2201', material_invoice_id: 't2mi02', description: 'VARILLAS 5/8"', amount: 120000, sort_order: 0 },
    { id: 'mii2202', material_invoice_id: 't2mi02', description: 'ESTRIBOS', amount: 78000, sort_order: 1 },
    { id: 'mii2301', material_invoice_id: 't2mi03', description: 'CEMENTO GRIS', amount: 180000, sort_order: 0 },
    { id: 'mii2302', material_invoice_id: 't2mi03', description: 'BLOQUE 6"', amount: 132400, sort_order: 1 },
  ],
  ...
  bitacora_entries: [
    {
      ...
      weather: 'soleado',
      temp_c: 30,
      work_summary: "Vaciado de columnas eje A-D. Se colocó hormigón f'c=280 kg/cm² en 12 columnas. Sin incidentes.",
      workforce_count: 18,
      equipment: 'Mixer, vibradora, andamios',
      visitors: 'Ing. Ramírez (inspección)',
      incidents: null,
      notes: 'Clima favorable, avance según cronograma.',
      created_by: 'Admin',
    ...
    },
    {
      ...
      weather: 'nublado',
      temp_c: 27,
      work_summary: 'Instalación de encofrado para placa nivel 2. Colocación de acero de refuerzo grado 60.',
      workforce_count: 22,
      equipment: 'Martillo rotativo, andamios',
      visitors: null,
      incidents: 'Trabajador con corte menor en mano — tratado en sitio',
      notes: 'Se reforzó protocolo de EPP.',
      created_by: 'Admin',
    ...
    },
    {
      ...
      weather: 'lluvia',
      temp_c: 24,
      work_summary: 'Suspensión de vaciado por lluvia. Trabajos interiores: mampostería bloque 6" en apartamento 1-A.',
      workforce_count: 12,
      equipment: 'Mezcladora de mortero',
      visitors: null,
      incidents: null,
      notes: 'Lluvia desde las 11am. Se cubrió el acero expuesto.',
      created_by: 'Admin',
    ...
    },
    {
      ...
      weather: 'soleado',
      temp_c: 31,
      work_summary: 'Cimentación nivel -1. Excavación completada eje 1-5. Colocación de plantilla de concreto pobre.',
      workforce_count: 25,
      equipment: 'Retroexcavadora, compresor',
      visitors: 'Cliente Lic. Torres (recorrido)',
      incidents: null,
      notes: 'Cliente satisfecho con el avance.',
      created_by: 'Admin',
      created_at: '2026-03-25T18:00:00Z',
    },
  ],
  ...
  attendance_records: [
    ...
    },
    {
      ...
      workers_count: 10,
      hours_worked: 9,
      activity: 'Encofrado placa nivel 2',
    ...
    },
    {
      ...
      workers_count: 3,
      hours_worked: 8,
      activity: 'Instalación panel eléctrico',
      notes: null,
      created_at: '2026-03-26T18:00:00Z',
    },
    {
      ...
      workers_count: 14,
      hours_worked: 8,
      activity: 'Excavación cimentación',
      notes: null,
      created_at: '2026-03-27T18:00:00Z',
    },
  ],
  ...
  inventory_movements: [
    ...
    },
    {
      ...
      date: '2026-03-25',
      supplier_id: null,
      notes: 'Vaciado columnas eje A-D',
    ...
    },
    {
      ...
      notes: 'Compra acero estructural',
  ...
  schedule_tasks: [
    {
      id: 'sc0001',
      project_id: projectId1,
      name: 'Cimentación y fundaciones',
    ...
    },
    {
      ...
      progress: 100,
      color: '#10b981',
      notes: 'Completado con 2 días de retraso',
      created_at: now,
    },
    {
      id: 'sc0003',
