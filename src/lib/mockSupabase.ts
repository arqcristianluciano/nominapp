...
export const mockSupabase = {
  ...
  // Realtime teardown helpers usados por hooks (p. ej. usePendingCortes) en su
  // cleanup. Sin esto, en modo demo `supabase.removeChannel` no existe y el
  // efecto de limpieza lanza, tumbando la página (visible con StrictMode).
