  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-app-muted mt-1">Selecciona un proyecto para gestionar contratos de ajuste</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-app-surface rounded-xl border border-app-border p-8 text-center">
          <Layers className="w-12 h-12 text-app-subtle mx-auto mb-3" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {activeProjects.map((project) => (
            <Link
              key={project.id}
              to={`/proyectos/${project.id}/cubicaciones`}
            ...
            >
              ...
              <div className="mt-4 pt-3 border-t border-app-border">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-app-muted">Contratos de ajuste · Cortes · Adelantos</span>
                </div>
              </div>
            </Link>
          ))}
