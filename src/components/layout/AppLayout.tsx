          ...
          <div className="flex items-center justify-between gap-3 px-4 py-2 bg-amber-50 border-b border-amber-200 text-xs text-amber-800">
            <div className="flex items-center gap-2">
              ...
              <span>
                ...
                <code className="font-mono bg-amber-100 px-1 rounded">.env</code> con tus credenciales
                de Supabase para conectar tu base de datos real.
              </span>
            </div>
            <button onClick={() => setDemoDismissed(true)} className="p-0.5 text-amber-500 hover:text-amber-700 shrink-0">
