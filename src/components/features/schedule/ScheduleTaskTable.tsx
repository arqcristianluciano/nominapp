          ...
          {tasks.map((task) => {
            ...
            return (
              <tr key={task.id} className="hover:bg-app-hover/50">
                ...
                <td className="px-4 py-3 text-xs"><span className={isDelayed ? 'text-red-500 font-semibold' : 'text-app-muted'}>{formatDateLong(task.end_date)}</span></td>
            ...
            <li key={task.id} className="px-3 py-3 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2 text-[11px]">
                ...
                <div>
                  ...
                  <span className={isDelayed ? 'text-red-500 font-semibold' : 'text-app-text'}>{formatDateLong(task.end_date)}</span>
                </div>
              </div>
              <div className="flex items-center gap-2">
