  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <button
          onClick={onCreate}
          className="flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-2 min-h-[44px] text-sm font-medium text-white hover:bg-blue-700 w-full sm:w-auto"
        >
