            ...
            <div className="flex items-start gap-3">
              <Link to={`/contratistas/${contractor.id}`} className="flex items-start gap-3 flex-1 min-w-0">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {isSub && (
                    <div className="mt-1">
                      <span className="inline-flex items-center gap-1 text-[11px] font-medium px-2 py-0.5 rounded-full bg-amber-100 text-amber-700 dark:bg-amber-950/50 dark:text-amber-300" title="Sub-contratista">
                        Sub-contratista de {parent?.name ?? '...'}
                      </span>
                    </div>
                  )}
