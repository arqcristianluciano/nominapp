  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          ...
          <input
            ...
            placeholder={t('contractors.form.specialty_placeholder')}
            className="w-full px-3 py-2 bg-app-input-bg text-app-text border border-app-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
        <div>
          ...
          <input
            ...
            placeholder={t('contractors.form.cedula_placeholder')}
            className="w-full px-3 py-2 bg-app-input-bg text-app-text border border-app-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
        <div>
        ...
        <div>
          <label className="block text-xs font-medium text-app-muted mb-1">
            {t('contractors.form.payment_method')}
          </label>
          <select
            value={paymentMethod}
        ...
        <div>
          <label className="block text-xs font-medium text-app-muted mb-1">
            {t('contractors.form.account_number')}
          </label>
          <input
            type="text"
            value={bankAccount}
        ...
        <div className="col-span-2">
          <label className="block text-xs font-medium text-app-muted mb-1">
            {t('contractors.form.parent_contractor')}
          </label>
          <select
            value={parentContractorId}
            onChange={(e) => setParentContractorId(e.target.value)}
            className="w-full px-3 py-2 bg-app-input-bg text-app-text border border-app-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
      ...
      <div className="flex justify-end gap-2 pt-2">
        ...
        >
          {saving
            ? t('contractors.form.saving')
            : initial
              ? t('contractors.form.update')
              : t('contractors.form.create')}
        </button>
      </div>
    </form>
  )
