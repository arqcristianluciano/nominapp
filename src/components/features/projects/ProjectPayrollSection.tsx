        ...
        {loading ? (
          ...
          <div className="bg-app-surface rounded-xl border border-app-border p-8 text-center">
            ...
            {canCreatePayroll && (
              <button
                onClick={onCreate}
                className="mt-3 text-sm text-blue-600 hover:text-blue-800 font-medium inline-flex items-center justify-center min-h-[44px] sm:min-h-0 px-2"
              >
              ...
              <div key={period.id} className="flex items-center gap-1 sm:gap-2">
                ...
                >
                  <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                    <div className="w-10 h-10 sm:w-10 sm:h-10 shrink-0 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center font-semibold text-sm">
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-2 sm:gap-3 pl-12 sm:pl-0">
                    <span
                      className={`px-2 py-0.5 text-xs font-medium rounded-full whitespace-nowrap ${statusColors[period.status]}`}
                    >
                      {statusLabels[period.status]}
                    </span>
                    <span className="text-sm font-medium text-app-text whitespace-nowrap break-all">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-1 shrink-0">
                  {canCreatePayroll && (
                    <button
                      ...
                      title={
                        draftPeriod
                          ? `Concluye el Reporte No. ${draftPeriod.period_number} antes de duplicar`
                          : 'Duplicar reporte'
                      }
