      ...
      <table className="w-full text-sm hidden sm:table">
        <thead>
          <tr className="bg-app-bg border-b border-app-border">
            ...
            <th className="text-right px-4 py-3 text-xs font-semibold text-app-subtle uppercase tracking-wide hidden lg:table-cell">
              DT %
            </th>
            <th className="w-10" />
          </tr>
          ...
          >
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <div className="font-semibold text-blue-600 dark:text-blue-400 text-sm truncate">{project.name}</div>
                <div className="text-xs text-app-subtle mt-0.5">{project.code}</div>
                {project.location && (
                  <div className="text-xs text-app-subtle mt-0.5 flex items-center gap-1">
