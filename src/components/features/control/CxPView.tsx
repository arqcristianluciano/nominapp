      ...
      {cxpItems.length === 0 ? (
        ...
        <>
          ...
          <div className="md:hidden space-y-3">
                ...
                <div key={idx} className="bg-app-surface rounded-xl border border-app-border p-3 shadow-sm">
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-2 text-[11px]">
                    ...
                    <div>
                      ...
                      <p className="text-app-text">{days}d</p>
                    </div>
                    <div>
                      <p className="text-app-muted uppercase tracking-wide text-[9px]">Condición</p>
                      <p className="text-app-text">{item.paymentCondition || '—'}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-app-muted uppercase tracking-wide text-[9px]">Pendiente</p>
                      <p className="text-red-700 dark:text-red-400 font-semibold text-sm">{formatRD(item.pending)}</p>
                    </div>
                  </div>
                  {days > 30 && (
                    <div className="mt-3 pt-3 border-t border-app-border">
                      <a
                        ...
                        className="flex items-center justify-center gap-2 w-full min-h-[44px] px-4 py-2.5 text-sm font-semibold text-white bg-green-600 border border-green-700 rounded-lg active:bg-green-700 dark:bg-green-600 dark:active:bg-green-700"
                      >
            ...
            <div className="bg-app-bg rounded-xl border border-app-border px-4 py-3 flex items-center justify-between">
              <span className="text-xs font-semibold text-app-muted uppercase">Total CxP</span>
              <span className="text-sm font-bold text-red-700 dark:text-red-400">{formatRD(totalCxP)}</span>
            </div>
          </div>

          {/* Desktop: table */}
          <div className="hidden md:block bg-app-surface rounded-xl border border-app-border overflow-hidden">
