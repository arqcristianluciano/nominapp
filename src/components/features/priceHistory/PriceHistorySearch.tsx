  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full min-h-[44px] pl-9 pr-4 py-2.5 text-base sm:text-sm border border-app-border rounded-xl bg-app-surface text-app-text focus:outline-none focus:ring-2 focus:ring-blue-500"
      />
    </div>
  )
}
