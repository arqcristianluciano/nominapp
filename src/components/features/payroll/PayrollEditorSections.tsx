...
import { AddMaterialForm, type NewMaterialInvoice } from '@/components/features/payroll/AddMaterialForm'
import type {
  BudgetCategory,
  Contractor,
  LaborLineItem,
...
export function PayrollEditorModals({
  ...
  onAddMaterial: (invoices: NewMaterialInvoice[]) => Promise<void>
  onAddLabor: (item: LaborItemPayload) => Promise<void>
  onUpdateLabor: (id: string, updates: LaborItemPayload) => Promise<void>
  onUpdateMaterial: (id: string, updates: MaterialUpdatePayload) => Promise<void>
      ...
      <Modal open={!!editMaterialInvoice} onClose={onCloseEditMaterial} title="Editar factura de materiales">
        {editMaterialInvoice && (
          <AddMaterialForm
            ...
            budgetCategories={budgetCategories}
            periodId={periodId}
            editInvoice={editMaterialInvoice}
            onSubmit={onAddMaterial}
