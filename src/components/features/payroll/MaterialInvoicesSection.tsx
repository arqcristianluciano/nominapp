...
function MaterialInvoiceMobileCardComponent({ invoice, isDraft, onEdit, onDelete }: MaterialInvoiceRowProps) {
  return (
...
function MaterialInvoiceRowComponent({ invoice, isDraft, onEdit, onDelete }: MaterialInvoiceRowProps) {
  return (
...
export function MaterialInvoicesSection({ invoices, isDraft, total, onOpenAdd, onEdit, onDelete }: Props) {
  return (
    <section>
