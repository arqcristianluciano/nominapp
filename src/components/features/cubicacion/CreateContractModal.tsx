...
export function CreateContractModal({
  ...
  const inputCls =
    'w-full px-3 py-2 border border-app-border rounded-lg text-sm bg-app-input-bg text-app-text focus:ring-2 focus:ring-blue-500'
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              onChange={(e) => onChange({ ...form, retention_percent: e.target.value })}
              className={inputCls}
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) => onChange({ ...form, signed_date: e.target.value })}
              className={inputCls}
            />
          </div>
        </div>
