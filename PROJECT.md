...
- Nóminas: draft → submitted → approved → paid
  - Editable mientras no esté aprobada (draft + submitted) por quien captura los datos (`edit_payroll`); tras la aprobación, solo usuarios autorizados (`approve_payroll`)
